...
window.addEventListener("load", function () {
    ...
    const sliders = document.querySelectorAll(".movies-wrapper");
    const nxtBtns = document.querySelectorAll(".movies-btn-prev");
    const preBtns = document.querySelectorAll(".movies-btn-next");
