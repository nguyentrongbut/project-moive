...
const sliderContainers = document.querySelectorAll(".movies__slider"); // Lấy tất cả các .movies__slider

sliders.forEach((slider, i) => {
    const nextBtn = nextBtns[i];
    const prevBtn = prevBtns[i];
    const sliderContainer = sliderContainers[i]; // Chọn phần tử .movies__slider tương ứng
    ...
    slider.addEventListener("scroll", () => {
        ...
        // Kiểm tra chiều rộng của slider và sliderContainer
        if (containerWidth >= sliderContainer.offsetWidth) {
            nextBtn.style.display = "none";
            prevBtn.style.display = "none";
        }
    });
