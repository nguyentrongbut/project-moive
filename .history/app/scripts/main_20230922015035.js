...
sliders.forEach((slider, i) => {
    ...
    let canClick = true; // Biến cờ cho phép thực hiện cuộc click
    ...
    nxtBtn.addEventListener("click", () => {
        if (canClick) {
            canClick = false; // Tắt cuộc click
            slider.scrollLeft -= containerWidth;
            setTimeout(() => {
                canClick = true; // Cho phép cuộc click tiếp theo sau một khoảng thời gian
            }, 500); // Đặt thời gian chờ tùy theo nhu cầu
        }
    });
