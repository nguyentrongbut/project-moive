...
loginBtn.addEventListener("click", function(e) {
    ...
    // Đánh dấu rằng người dùng đã nhấp vào nút đăng nhập
    isLoginClicked = true;
});

// Sau khi người dùng nhấp vào nút đăng nhập, thêm sự kiện input vào emailInput
...
Mã này sẽ đánh dấu rằng người dùng đã nhấp vào nút đăng nhập bằng cách thiết lập biến isLoginClicked thành true. Sau đó, sự kiện input trên emailInput chỉ được kích hoạt nếu isLoginClicked là true.
