...
window.addEventListener("load", function () {
    const input = document.querySelector(".header__input");
    const listHeader = document.querySelectorAll(".header__hotSearch");
    const items = document.querySelectorAll(".header__hotSearch--link");
    const headerHotSearch = document.querySelector(".header__hotSearch"); // Get the .header__hotSearch element
    ...
    function handleHighlight(e) {
        ...
        // Track if any items are displayed
        let anyItemDisplayed = false;
        ...
        // If no items are displayed, add a class to .header__hotSearch
        if (!anyItemDisplayed) {
            headerHotSearch.classList.add("hidden-padding");
        } else {
            headerHotSearch.classList.remove("hidden-padding"); // Remove the class
        }
    }
});
