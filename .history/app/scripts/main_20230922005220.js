...
window.addEventListener("load", function () {
    ...
    const sliders = document.querySelector(".movies__wrapper");
    const slidersCard = document.querySelectorAll(".movies__card");
    const nextSlider = document.querySelector(".movies__btn-next");
    const prevSlider = document.querySelector(".movies__btn-prev");
    const slidersWidth = sliders[0].offsetWidth;
    const slidersLength = slidersCard.length;
    let positionX = 0;
    let index = 0;
    ...
    function handleChangeSlide(direction) {
        if (direction === 1) {
            ...
            positionX = positionX - slidersWidth;
            sliders.style = `transform: translateX(${positionX}px)`;
            index ++;
        } else if (direction === -1) {
            if (index <= 0) {
                index = 0;
