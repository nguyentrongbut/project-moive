...
<a href="/anime.html" id="animeLink">Anime</a>

<script>
  document.getElementById('animeLink').addEventListener('click', function(event) {
    event.preventDefault(); // Ngăn chặn hành vi mặc định của thẻ a
    window.location.href = this.getAttribute('href').replace('.html', ''); // Chuyển đến URL mới
  });
</script>
