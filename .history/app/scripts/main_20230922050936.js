...
// Gọi hàm để xác định liên kết active ban đầu và sau mỗi lần thay đổi URL
setActiveLink();

// Lắng nghe sự kiện thay đổi URL (dựa vào sự kiện 'popstate' hoặc 'hashchange' tùy vào cách bạn thay đổi URL)
