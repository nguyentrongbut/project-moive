...
sliders.forEach((slider, i) => {
    ...
    slider.addEventListener("scroll", () => {
        isScrolling = true; // Bật cờ đang scroll
    ...
    // Kiểm tra xem sự kiện scroll đã kết thúc
    slider.addEventListener("scroll", () => {
        clearTimeout(scrollTimer); // Hủy bỏ đếm thời gian
        scrollTimer = setTimeout(() => {
            isScrolling = false; // Tắt cờ đang scroll sau một khoảng thời gian ngắn
        }, 100); // Đặt thời gian tùy theo nhu cầu
    });
});
