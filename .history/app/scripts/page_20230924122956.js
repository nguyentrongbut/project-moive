...
function handleClickMore() {
    if (displayValue.includes("-webkit-box")) {
        ...
        btnMorePage.style.right = "-72px";
        btnMorePage.style.bottom = "-4px";
    } else {
        descPage.style.display = "-webkit-box";
        // Cập nhật displayValue sau khi thay đổi thuộc tính "display"
        displayValue = window.getComputedStyle(descPage).getPropertyValue('display');
