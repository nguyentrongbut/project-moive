...
window.addEventListener("load", function () {
    ...
    sliders.forEach((slider, i) => {
        ...
        slider.addEventListener("scroll", () => {
            ...
            if (scrollLeft === 0) {
                prevBtn.style.display = "none"; // Ẩn nút "prev" nếu ở đầu slider
            } else {
                prevBtn.style.display = "block"; // Hiển thị nút "prev" nếu có nội dung bên trái để cuộn
            }
    
            if (scrollLeft + containerWidth >= contentWidth) {
                nextBtn.style.display = "none"; // Ẩn nút "next" nếu ở cuối slider
            } else {
                nextBtn.style.display = "block"; // Hiển thị nút "next" nếu có nội dung bên phải để cuộn
            }
        });
