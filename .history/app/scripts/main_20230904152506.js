    ...
    function handleHighlight(e) {
        ...
        [...items].forEach((item) => {
            ...
            if (filter === "") {
                ...
                // Kiểm tra xem filter có phù hợp với text không
                const isMatch = text.includes(filter) || text === filter;

                if (isMatch) {
                    // Nếu filter phù hợp, hiển thị phần tử mà không ẩn nó và highlight phần tử đó
                    item.parentNode.style.display = "block";
