...
window.addEventListener("load", function () {
    ...
    sliders.forEach((slider, i) => {
        ...
        slider.addEventListener("scroll", () => {
            // Kiểm tra xem cuộn chuột có được kích hoạt bởi người dùng hay không
            if (isScrolling) {
        ...
        nxtBtn.addEventListener("click", () => {
            // Tạm ngừng cuộn chuột bằng cách đặt biến kiểm tra
            isScrolling = false;
            slider.scrollLeft -= containerWidth;
            // Khôi phục cuộn chuột sau một khoảng thời gian ngắn
            setTimeout(() => {
                isScrolling = true;
            }, 100);
        });
        ...
        // Đặt lại biến kiểm tra sau một khoảng thời gian ngắn
        setTimeout(() => {
            isScrolling = true;
        }, 100);
    });
