...
window.addEventListener("load", function () {
    ...
    function handleHighlight(e) {
        ...
        [...items].forEach((item) => {
            ...
            const indexHasSpace = textLower.indexOf(textedHasSpace);
            const indexNoSpace = textLower.indexOf(textedNoSpace);
            console.log(index);
            ...
            if (indexHasSpace >= 0) {
                ...
                const capitalizedText = capitalizeFirstLetter(matc);
